  ...
  >
    ...
    >
      ...
      <div class="flex">
        ...
        <button
          class="font-extrabold leading-none tracking-wide select-none shrink-0 p-3 text-white bg-orange-600 rounded hover:bg-orange-500 focus:bg-orange-500 transition-colors duration-200 focus:outline-none"
          @click="cropPhoto"
        >
          Crop gambar
        </button>
