    ...
    <div :id="`Theme${theme}`">
      ...
      >
        <head>
          ...
          <meta
            name="author"
            content="HTML Card Generator by KawanHTML"
          />
          <meta name="url" content="https://kawanhtml.com/" />
          <meta name="designer" content="KawanHTML" />
          <meta
            property="og:title"
            :content="`${getFullname}'s Virtual Card`"
          />
          <meta
          ...
          <title>{{ getFullname }}'s Virtual Card</title>
          <style>
        ...
        <body id="body">
          ...
          >
            ...
            <div id="qrView" ref="qrView" class="textColor">
              <div id="qr"></div>
              <h3>Scan QR Code</h3>
              <p>untuk melihat kartu saya di perangkat lain</p>
            </div>
          </div>
          <header>
            <div
          ...
          >
            ...
            >
              ...
              ></div>
              <p class="iconColor">Simpan kontak</p>
            </a>
            <div class="actions">
              <div
                class="actionsC"
          ...
          >
            ...
            <a
              class="textColor"
              href="https://shop.kawanhtml.com/"
              target="_blank"
              rel="noopener noreferrer"
              >HTML Card Generator</a
            >
          </footer>
        </body>
      </html>
...
export default {
  ...
  methods: {
    ...
    sharingAlert() {
      this.showAlert(
        'Kamu bisa membagikan kartu virtual ini setelah melengkapi proses hostingan.\n\nSilahkan lihat <a class="underline font-extrabold text-orange-600 hover:text-orange-500 transition-colors duration-200" href="/demo" target="_blank">demo</a> untuk menguji program.'
      )
    },
    togglePlay(ref) {
