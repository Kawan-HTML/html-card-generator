<template>
  <div
    ref="container"
    class="bg-gradient-to-br from-gray-900 to-indigo-900 min-h-screen text-gray-100 mx-auto px-4 sm:px-6 lg:px-14"
  ...
  >
      ...
      >
        ...
        <button
          class="
            ...
            select-none
          "
          :class="showPreview ? 'bg-gray-700' : 'bg-orange-600'"
    ...
    <div class="px-4">
      ...
      <a class="
          ...
          target="_blank"
          >Kembali</a>
      <h1 class="text-4xl md:text-6xl font-extrabold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 mt-24">
        Buat Virtual Card mu sekarang
      </h1>
      <p class="mt-8 text-lg md:text-xl w-full md:w-3/4 text-gray-200">
        HTML Card Generator membantu Anda membuat kartu virtual yang menarik dan responsif
        yang dapat di-hosting di situs web Anda.
      </p>
      <ul class="mt-4 text-gray-400">
        <li>-&ensp;Tidak perlu sign-Up</li>
        <li>-&ensp;100% gratis untuk pembuatan kartu virtual</li>
        <li>-&ensp;Data Anda dijamin aman</li>
        <!-- <li>-&ensp;Offline</li> -->
      </ul>
    ...
    <div class="md:grid md:grid-cols-2">
      <div class="px-4 mt-32">
        <div ref="create" id="step-1" class="pt-8">
          <h2 class="font-extrabold text-2xl">Tampilan Profil</h2>
          <div class="stepC">
            <Attachment
              :content="images"
              type="logo"
              ...
              label="Tambah logo"
              description="format yang disarankan: svg, png or gif"
              :showAlert="showAlert"
            />
            <Attachment
              :content="images"
              type="cover"
              :resizeImage="resizeImage"
              label="Tambah sampul foto"
              description="format yang disarankan: svg, jpeg, png or gif"
              :showAlert="showAlert"
            />
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
              Ukuran sampul foto yang disarankan adalah 960 x 640 piksel, dengan
              rasio aspek 3:2
            </p>
          </div>
        </div>
        <div id="step-2" class="mt-16">
          <h2 class="font-extrabold text-2xl">Informasi kontak</h2>
          <Attachment
            :content="images"
            type="photo"
            :resizeImage="resizeImage"
            label="Tambah foto profil"
            description="format yang disarankan: jpeg, png or gif"
            :showAlert="showAlert"
          />
          <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
            Ukuran foto profil yang disarankan adalah 320 x 320 piksel, dengan
            rasio aspek 1:1
          </p>
          <div class="stepC mt-6 grid grid-cols-2 gap-4">
            <div>
              <label for="firstname" class="ml-4">Nama depan</label>
              <input
                id="firstname"
                spellcheck="false"
                type="text"
            ...
            <div>
              <label for="lastname" class="ml-4">Nama belakang</label>
              <input
                id="lastname"
                spellcheck="false"
                type="text"
          ...
          <div class="stepC mt-6">
            <label for="job-title" class="ml-4">Pekerjaan</label>
            <input
              id="job-title"
              type="text"
              spellcheck="true"
          ...
          <div class="stepC mt-6">
            <label for="business-name" class="ml-4">Nama institusi/perusahaan</label>
            <input
              id="business-name"
              spellcheck="false"
              type="text"
          ...
          <div class="stepC mt-6">
            <label for="business-address" class="ml-4">Alamat</label>
            <textarea
              id="business-address"
              :value="genInfo.addr"
        ...
        <div id="step-3" class="mt-16">
          <h2 class="font-extrabold text-2xl">Kontak pribadi</h2>
          <draggable
        ...
        <div id="step-5" class="mt-16">
          <h2 class="font-extrabold text-2xl">Konten unggulan</h2>
          <div class="stepC">
            <draggable
              v-model="featured"
              handle=".drag"
            ...
            <div class="flex mt-6">
              <div class="flex flex-wrap items-center">
                ...
                <p class="ml-3 leading-none">Tambah konten</p>
              </div>
            </div>
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
              format media yang didukung: jpeg, png, mp3, mp4, webm dan pdf
            </p>
          </div>
        </div>
        <div id="step-6" class="mt-16">
          <h2 class="font-extrabold text-2xl">Kredit</h2>
          <div class="stepC mt-6">
            <div class="flex items-center">
              ...
              <p>{{ footerCredit ? 'Aktif' : 'Nonaktif' }}</p>
            </div>
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
              Dengan mengaktifkan kredit, Anda dapat membantu proyek ini
              mencapai lebih banyak orang.
            </p>
          </div>
        </div>
        <div id="step-7" class="mt-16">
          <h2 class="font-extrabold text-2xl">Tema</h2>
        ...
        <div id="step-8" class="mt-16">
          <h2 class="font-extrabold text-2xl">Warna</h2>
          <div class="stepC">
            <Colour name="logoBg" label="Header background" :colors="colors" />
            <Colour name="mainBg" label="Background utama" :colors="colors" />
            <Colour
              name="buttonBg"
              label="Background tombol"
              :colors="colors"
            />
            <Colour
              name="cardBg"
        ...
        <div id="step-9" class="mt-16">
          ...
          <div class="stepC mt-6">
            <label for="font-link" class="ml-4">Lampirkan code font (Opsional)</label>
            <textarea
              id="font-link"
          ...
          <div class="stepC mt-6">
            <label for="font-css" class="ml-4">Atur font CSS (Opsional)</label>
            <input
              spellcheck="false"
              type="text"
              id="font-css"
          ...
          <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
            Mendukung layanan seperti Google Fonts, Adobe Typekit, dll. Pastikan
            untuk mendapatkan kode sematan untuk varian font reguler dan bold
            dari family font yang sama.
          </p>
        </div>
        <div id="step-10" class="mt-16">
          <h2 class="font-extrabold text-2xl">Analisis</h2>
          <div class="stepC mt-6">
            ...
            <textarea
              ...
              rows="4"
              spellcheck="false"
              placeholder="Tempel tracking code disini"
            ></textarea>
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
              Mendukung layanan seperti Clicky, Matomo, Google Analytics dll.
            </p>
          </div>
        </div>
        <div id="step-11" class="mt-16">
          ...
          <div class="stepC mt-6">
            ...
            />
            <p class="mt-6 border p-4 rounded border-gray-700 text-gray-400">
              Tempel URL hosting jika Anda sudah memutuskan di mana Anda ingin
              meng-host kartu virtual ini. Jika Anda belum memutuskan,
              silakan lewati langkah ini.
            </p>
          </div>
        </div>
        <Download
  ...
  data() {
    return {
      downloadCheckList: [
        {
          label:
            'Saya tidak melampirkan link atau file yang berpotensi merusak',
          checked: false,
        },
        {
          label: 'Saya telah memeriksa semua link dan berfungsi dengan baik',
          checked: false,
        },
        {
          label: 'Saya telah menghapus semua bagian yang tidak terpakai',
          checked: false,
        },
      ],
      images: {
    ...
    downloadPackage() {
      if (this.downloadChecked) {
        ...
        setTimeout(() => {
          ...
          let guide = new Blob(
            [
              '<html><head><meta http-equiv="refresh" content="0; url=https://kawanhtml.com" /></head></html>',
            ],
            {
              type: 'text/html',
            }
          ...
          zip
            ...
            .then(function (zip) {
              saveAs(zip, `${name}'s Virtual Card.zip`)
            })
