export default {
  ...
  meta: {
    ...
    // ogUrl: false,
    ogTitle: 'HTML Card Generator',
    ogDescription:
      'HTML Card Generator membantu Anda membuat kartu virtual yang menarik dan responsif yang dapat di-hosting di situs web Anda.',
    ogSiteName: 'HTML Card Generator',
    theme_color: '#111827',
    author: 'kawanhtml',
    lang: 'id',
  ...
  manifest: {
    name: 'HTML Card Generator',
    short_name: 'HTML Card Generator',
    start_url: '/',
    display: 'standalone',
    theme_color: '#111827',
